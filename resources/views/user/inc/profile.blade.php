...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow">
            ...
            <label class="btn btn-default"> {{__('Upload Profile Image')}}
...
<div class="row">
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'first_name') !!}">
			<label for="">{{__('First Name')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'last_name') !!}">
			<label for="">{{__('Last Name')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'country_id') !!}">
			<label for="">{{__('Country')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'state_id') !!}">
			<label for="">{{__('State')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'city_id') !!}">
			<label for="">{{__('City')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'nationality_id') !!}">
			<label for="">{{__('Nationality')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'date_of_birth') !!}">
			<label for="">{{__('Date of Birth')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'mobile_num') !!}">
			<label for="">{{__('Mobile')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'street_address') !!}">
			<label for="">{{__('Street Address')}} <a style="color: #db1207;">*</a></label>
...
<div class="row">
 <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}">
			<label for="">{{__('Job Experience')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'career_level_id') !!}">
			<label for="">{{__('Career Level')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'industry_id') !!}">
			<label for="">{{__('Select Industry')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}">
			<label for="">{{__('Functional Area')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'salary_currency') !!}">
			<label for="">{{__('Salary Currency')}} <a style="color: #db1207;">*</a></label>			
            @php
