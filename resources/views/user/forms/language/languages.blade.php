<h5 onclick="showLanguages();">{{__('Languages')}} <a style="color: #db1207;">*</a></h5>
<div class="row">
    <div class="col-md-12">
...
<hr>
<div class="modal" id="add_language_modal" role="dialog" tabindex="-1" aria-labelledby="myModal" aria-hidden="true"></div>
@push('scripts') 
