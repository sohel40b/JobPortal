				        ...
				        <div class="srchbx">				
                            ...
                            <div class="srchint">
                                <ul class="row catelist">
                                    ...
                                    @php $company = $functional_area_id_num_jobs->getCompany();  @endphp
                                    <?php
                                    $active = App\ Job::getActiveById($functional_area_id_num_jobs->is_active);
                                    ?>
                                    <?php
                                    $featured = App\ Job::getFeaturedById($functional_area_id_num_jobs->is_featured);
                                    ?>
                                    <?php
