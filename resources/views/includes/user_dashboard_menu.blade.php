<div class="col-lg-3">
	<div class="usernavwrap">
        <div class="switchbox">
            <div class="txtlbl">{{__('Available For Work')}} <i class="fa fa-info-circle" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="{{__('Are you immediate available')}}?" data-original-title="{{__('Are you immediate available')}}?" title="{{__('Are you immediate available')}}?"></i>
            </div>
            <div class="">
        ...
        <ul class="usernavdash">
            <li class="active"><a href="{{route('home')}}"><i class="fa fa-tachometer" aria-hidden="true"></i> {{__('Dashboard')}}</a></li>
            <hr class="hr1">
            <li><a href="" style="color: #29ad24; font-weight: bold;"> {{__('RESUME')}}</a></li>
            <hr>
            <li><a href="{{ route('view.cv.profile', Auth::user()->id) }}"><i class="fa fa-file" aria-hidden="true"></i> {{__('View Resume')}}</a></li>
            <li><a href="{{ route('my.profile') }}"><i class="fa fa-pencil" aria-hidden="true"></i> {{__('Edit Resume')}}</a></li>
            <hr>
            ...
            <li><a href="{{ route('my-alerts') }}"><i class="fa fa-bullhorn" aria-hidden="true"></i> {{__('My Job Alerts')}}</a></li>
            ...
            <hr>
            <li><a href=""><i class="fa fa-cogs"></i> {{__('More Setting')}}</a></li>
