<h5>{{__('Hot Job Details')}}</h5>
@if(isset($job))
{!! Form::model($job, array('method' => 'put', 'route' => array('update.hot.job', $job->id), 'class' => 'form')) !!}
{!! Form::hidden('id', $job->id) !!}
@else
{!! Form::open(array('method' => 'post', 'route' => array('store.hot.job'), 'class' => 'form')) !!}
@endif
<div class="row">  
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'title') !!}">
            <label>{{__('Job Title')}} <a style="color: #db1207;">*</a></label> 
            {!! Form::text('title', null, array('class'=>'form-control', 'id'=>'title', 'placeholder'=>__('e.g. "Finance Manager"'))) !!}
            {!! APFrmErrHelp::showErrors($errors, 'title') !!}
        </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'functional_area_id') !!}" id="functional_area_id_div">
            <label>{{__('Functional Area')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'career_level_id') !!}" id="career_level_id_div">
            <label>{{__('Career Level')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'degree_level_id') !!}" id="degree_level_id_div">
            <label>{{__('Degree Level')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'job_experience_id') !!}" id="job_experience_id_div">
            <label>{{__('Job Experience')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'job_type_id') !!}" id="job_type_id_div">
            <label>{{__('Job Type')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-6">
        ...
        <label>{{__('Number Of Positions')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'description') !!}">
            <label>{{__('Job Description')}} <a style="color: #db1207;">*</a></label> 
            {!! Form::textarea('description', null, array('class'=>'form-control', 'id'=>'description', 'placeholder'=>__('e.g. "Job Description"'))) !!}
	 ...
	 <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'benefits') !!}">
            <label>{{__('Job Benefits')}} <a style="color: #db1207;">*</a></label> 
            {!! Form::textarea('benefits', null, array('class'=>'form-control', 'id'=>'benefits', 'placeholder'=>__('e.g. "Job Benefits"'))) !!}
    ...
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'skills') !!}">
            ...
            ?>
            <label>{{__('Requried Skills')}} <a style="color: #db1207;">*</a></label> 
    ...
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'country_id') !!}" id="country_id_div">
            <label>{{__('Country')}} <a style="color: #db1207;">*</a></label> 
    ...
    <div class="col-md-4">
        ...
        <label>{{__('State')}} <a style="color: #db1207;">*</a></label> 
            <span id="default_state_dd">
            {!! Form::select('state_id', ['' => __('Select State')], null, array('class'=>'form-control', 'id'=>'state_id')) !!} </span> 
            {!! APFrmErrHelp::showErrors($errors, 'state_id') !!}
        </div>
    </div>
    <div class="col-md-4">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'city_id') !!}" id="city_id_div">
        <label>{{__('City')}} <a style="color: #db1207;">*</a></label>
        <span id="default_city_dd"> 
            {!! Form::select('city_id', ['' => __('Select City')], null, array('class'=>'form-control', 'id'=>'city_id')) !!} </span> 
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'salary_from') !!}" id="salary_from_div">
            ...
            {!! Form::number('salary_from', null, array('class'=>'form-control', 'id'=>'salary_from', 'placeholder'=>__('e.g. "40000 Tk"'))) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'salary_to') !!}" id="salary_to_div">
            ...
            {!! Form::number('salary_to', null, array('class'=>'form-control', 'id'=>'salary_to', 'placeholder'=>__('e.g. "80000 Tk"'))) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'expiry_date') !!}">
            <label>{{__('Job Expiry Date')}} <a style="color: #db1207;">*</a></label>
    ...
    <div class="col-md-12">
        <div class="formrow">
            <button type="submit" class="btn">{{__('Update Hot Job')}} <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.select2-multiple').select2({
            placeholder: "{{__('e.g. Communication Skills')}}",
            allowClear: true
        });
