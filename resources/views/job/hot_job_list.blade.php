...
@include('includes.inner_page_title', ['page_title'=>__('Hot Job Listing')]) 
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        ...
                                        <div class="jobinfo">
                                            <h3><a href="{{route('hot.job.detail', [$job->slug])}}" title="{{$job->title}}">{{$job->title}}</a></h3>
                                    ...
                                    <div class="col-md-4 col-sm-4">
                                        <div class="listbtn"><a href="{{route('hot.job.detail', [$job->slug])}}">{{__('View Details')}}</a></div>
                                    </div>
                                </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <form id="submit_alert">
                ...
                <input type="hidden" name="country_id" value="{{ Request::get('country_id')[0] }}">
                <input type="hidden" name="state_id" value="{{ Request::get('state_id')[0] }}">
                <input type="hidden" name="city_id" value="{{ Request::get('city_id')[0] }}">
                <input type="hidden" name="functional_area_id" value="{{ Request::get('functional_area_id')[0] }}">
