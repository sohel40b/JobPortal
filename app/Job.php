...
class Job extends Model
{
    ...
    {
        $active = self::where('jobs.is_active', '=', $id)->active()->first();
    ...
    public static function getFeaturedById($id)
    {
        $featured = self::where('jobs.is_featured', '=', $id)->featured()->first();
    ...
    {
        return $this->hasMany('App\MatchingDataMailProcess', 'job_id', 'id');
    }
    /*     * ***************************** */
}
