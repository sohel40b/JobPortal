        ...
        if (isset($user) && count($user->profileEducation)):
            foreach ($user->profileEducation as $education):
                ...
                <div class="w3-container">
                    <h5 class="w3-opacity">' . $education->getDegreeLevel('degree_level') . ' - ' . $education->getDegreeType('degree_type') . '</h5>
                    <h6 class="w3-opacity">' . $education->institution . '</h6>
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>Complete:- ' . $education->date_completion . '</h6>
