...
trait JobTrait
{
    ...
    public function createFrontJob()
    {
		...
		if ((bool)$company->industry_id === false) {
            flash(__('Please Update Your Account Information!!'))->error();
            flash(__('Example:- Goto==> Edit Profile'))->error();
    ...
    public function storeFrontJob(JobFrontFormRequest $request)
    {
        ...
        flash('Job has been added! Please Wait.... Admin check your post and Live your Job Post as soon as possible')->success();
