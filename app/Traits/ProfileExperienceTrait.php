            ...
            foreach ($user->profileExperience as $experience):
                ...
                $html .= '<li>
                  <div class="w3-container">
                      <h3 class="w3-opacity w3-text-black">' . $experience->title . '</h3>
                      <h5 class="w3-opacity">' . $experience->company . ' | ' . $experience->getCity('city') . '</h5>
                      <div class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>From ' . $experience->date_start->format('d M, Y') . ' - ' . $date_end . '</div>
